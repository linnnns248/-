...
const LOCAL_SPECIALTIES = [
  { name: '老妈蹄花', image: 'https://images.unsplash.com/photo-1541544741938-0af808871cc0?auto=format&fit=crop&q=80&w=200', score: '9.8', type: '招牌名吃' },
  { name: '冷锅串串', image: 'https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?auto=format&fit=crop&q=80&w=200', score: '9.6', type: '必进店' },
  { name: '蛋烘糕', image: 'https://images.unsplash.com/photo-1626074353765-517a681e40be?auto=format&fit=crop&q=80&w=200', score: '9.9', type: '非遗传承' },
];

const FEATURED_MERCHANT = {
  name: '老成都·盘飧市',
  logo: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&q=80&w=100',
  ...
  whyFamous: '百年老字号，成都人的味道记忆，始于1925年的匠心传承',
          ...
          <main className="relative z-10">
            ...
            <section className="px-4 mb-3">
              <div className="bg-white rounded-[24px] shadow-md border border-gray-50 overflow-hidden relative isolate">
                ...
                <div className="bg-gradient-to-br from-orange-50 to-white/0 px-4 pt-3 pb-1">
                   <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1.5 relative">
                        ...
                        <h2 className="font-extrabold text-[13px] text-gray-900 tracking-tight">成都寻味指南</h2>
                      ...
                      <div className="flex gap-1">
                        <div className="bg-red-50 text-red-500 text-[8px] font-black px-1.5 py-0.5 rounded border border-red-100 flex items-center gap-1 shadow-sm">
                           <Ticket className="w-2.5 h-2.5" />
                           <span>最高满60-30</span>
                        </div>
                        <div className="bg-orange-50 text-orange-600 text-[8px] font-black px-1.5 py-0.5 rounded border border-orange-100 shadow-sm">
                           <span>低至免配</span>
                        </div>
                      </div>
                   </div>
                ...
                {/* 2) Primary Card: Featured Merchant - Top Image Bottom Text */}
                <div className="px-3 mb-3">
                  <motion.div 
                    whileTap={{ scale: 0.98 }}
                    className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100 transition-all hover:shadow-md group cursor-pointer"
                  >
                    <div className="relative h-[120px] overflow-hidden">
                      ...
                      />
                      <div className="absolute top-2 left-2 bg-black/60 backdrop-blur-md text-white text-[7px] font-black px-1.5 py-0.5 rounded shadow-sm flex items-center gap-1 uppercase tracking-widest bg-brand-primary text-black ring-1 ring-black/5">
                    ...
                    <div className="p-3">
                      <div className="flex items-center gap-2 mb-2">
                        <img 
                          ...
                          alt="logo" 
                          className="w-8 h-8 rounded-lg object-cover ring-2 ring-gray-100 flex-shrink-0" 
                          referrerPolicy="no-referrer"
                        />
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-1.5 mb-1">
                            <h3 className="text-gray-900 font-black text-[14px] leading-tight truncate tracking-tight">{FEATURED_MERCHANT.name}</h3>
                            <div className="bg-red-500 text-white text-[8px] font-black px-1 rounded-sm ring-1 ring-red-400/50 flex-shrink-0">
                               {FEATURED_MERCHANT.coupon}
                            </div>
                          </div>
                          <div className="flex items-center flex-wrap gap-x-2 gap-y-0.5 text-[8px] font-bold text-gray-500">
                            ...
                            <span className="opacity-40">|</span>
                            <span>{FEATURED_MERCHANT.deliveryFee}</span>
                            <span className="opacity-40">|</span>
                      ...
                      {/* Integrated Specialty Tags + Merchant Description */}
                      <div className="py-1.5 border-t border-gray-50 mt-1">
                         <div className="flex items-start gap-1.5">
                            <div className="bg-orange-100 p-0.5 rounded mt-0.5 flex-shrink-0">
                               <Flame className="w-2 h-2 text-orange-600" />
                            </div>
                            <div className="flex flex-wrap items-start gap-1.5 min-w-0">
                               <div className="flex gap-1 flex-shrink-0 mt-0.5">
                                  {FEATURED_MERCHANT.specialtyDishes.map((dish, i) => (
                                      <span
                                        key={i}
                                        className="px-1 py-0 bg-orange-50 text-orange-600 text-[8px] font-black rounded-sm border border-orange-100"
                                      >
                                        {dish}
                                      </span>
                                  ))}
                               </div>
                               <p className="text-[9px] text-gray-500 font-medium leading-relaxed italic line-clamp-2 flex-1">{FEATURED_MERCHANT.whyFamous}</p>
                            </div>
                         </div>
                      </div>
                    </div>
                ...
                {/* 3) Specialty Strips - Local Queue King (Banner style) */}
                <div className="px-3 pb-4">
                   <motion.div 
                     whileTap={{ scale: 0.98 }}
                     className="bg-gradient-to-r from-orange-400 to-orange-500 rounded-xl p-3 shadow-lg shadow-orange-200/50 relative overflow-hidden group cursor-pointer"
                   >
                      ...
                      <div className="relative z-10 flex items-center justify-between">
                        <div>
                          <div className="flex items-center gap-1.5 mb-0.5">
                            <span className="text-[12px] font-black text-white tracking-tight">当地排队王</span>
                            <div className="bg-white/20 backdrop-blur-md px-1.5 rounded text-[7px] font-black text-white border border-white/10">
                              HOT
                            </div>
                          </div>
                          <p className="text-[8px] text-white/80 font-bold">线下火爆名店，外卖一键直达</p>
                        </div>
